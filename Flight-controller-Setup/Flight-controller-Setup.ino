...
void loop(){
  ...
  if(error == 0){
   ...
   Serial.println(F("contact Swarnim Sharma for more information about this error."));
  }
  while(1);
}
...
void intro(){
  ...
  delay(1000);
  Serial.println(F(""));
  Serial.println(F(" Flight-controller-Setup Program"));
  Serial.println(F(""));
  Serial.println(F("==================================================="));
  delay(1500);
  Serial.println(F("For any Questions contact: Swarnim Sharma"));
  Serial.println(F(""));
